...
public class WebViewAdapter extends RecyclerView.Adapter<WebViewAdapter.WebViewViewHolder> {
    List<Job> htmlList;
    Activity activity;


    public WebViewAdapter(Activity activity, List<Job> htmlList) {
    ...
    public void onBindViewHolder(@NonNull WebViewViewHolder holder, int position) {
        holder.bindView(htmlList.get(position).getName());
    }
