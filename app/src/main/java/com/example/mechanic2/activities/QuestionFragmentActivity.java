...
public class QuestionFragmentActivity extends AppCompatActivity  implements View.OnClickListener {
    private boolean x;
    ...
    private void init(Activity inflate) {
        ...
        recyclerQuestion.setLayoutAnimation(new LayoutAnimationController(AnimationUtils.loadAnimation(getContext(), android.R.anim.slide_in_left)));
...
/*
        ...
        spinnerFilter.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                QuestionFragmentActivity.this.parentAdapterView = parent;
                i++;
                if (view != null) {
                    modifyIds();
        ...
        CarAutoCompleteAdapter carAdapter = new CarAutoCompleteAdapter(QuestionFragmentActivity.this, R.layout.item_show_auto_complete,true);
        carQuestion.setAdapter(carAdapter);
        TitleQuestionAutoCompleteAdapter goodAdapter = new TitleQuestionAutoCompleteAdapter(getContext(), R.layout.item_show_auto_complete,true);
...
/*
            ...
            case R.id.reset_title:
                ...
                titleQuestion.setText("");
                myQuestion.setEnabled(true);
                myQuestion.setBackground(QuestionFragmentActivity.this.getDrawable(R.drawable.btn_inactive_stoke));
                selectedTitleId = 0;
                app.l("selectedCarId:" + selectedCarId);
        ...
        switch (v.getId()) {
            case R.id.fab_my_layout:
                break;
            case R.id.fab_add_layout:
                startActivityForResult(new Intent(QuestionFragmentActivity.this, AddQuestionActivity.class), 1);
                break;
        }
    ...
    private void getQuestions(int carId, int titleId, int sortBy, int showMyQuestion) {
        ...
        adapter = new QuestionRecyclerAdapter(questions, QuestionFragmentActivity.this);
        ...
        btnAddQuestion.setOnClickListener(QuestionFragmentActivity.this);
        btnShowAllQuestions.setOnClickListener(QuestionFragmentActivity.this);
            ...
            public void onResponse(Call<QusetionWithMsg> call, Response<QusetionWithMsg> response) {
                ...
                if (response.body() != null && response.body().getQuestion().size() > 0) {
                    ...
                    if (questions != null && questions.size() != 0) {
                        ...
                        QuestionFragmentActivity.this.lastId = questions.get(questions.size() - 1).getQ_id();
                        QuestionFragmentActivity.this.lastSeenCount = questions.get(questions.size() - 1).getSeen_count();
                    } else {
                        if (questions != null) {
                            app.t("not found11");
                            isLoading = false;
                    ...
                    LocalBroadcastManager.getInstance(QuestionFragmentActivity.this).sendBroadcast(intent);
                    adapter = new QuestionRecyclerAdapter(tmpQuestions, QuestionFragmentActivity.this);
        ...
        Application.getApi().getQuestionWithMsg(map).enqueue(new Callback<QusetionWithMsg>() {
            ...
            public void onResponse(Call<QusetionWithMsg> call, Response<QusetionWithMsg> response) {
                ...
                if (newQuestions != null) {
                    ...
                    QuestionFragmentActivity.this.lastId = newQuestions.get(newQuestions.size() - 1).getQ_id();
                    QuestionFragmentActivity.this.lastSeenCount = newQuestions.get(newQuestions.size() - 1).getSeen_count();
                }
                if (newQuestions != null) {
